...
# 3. Simulate Choices based on estimated coefficients (Behavioral Digital Twin Simulation)
# [PAI-Logic]: Mapping Latent Perspectives for Behavioral Digital Twin
# We simulate how latent perspectives (UrbanRural, Trust) shape the utility of wait-time friction.
...
# [PAI-Logic]: Auditing Subgroup Sensitivity (NICA Framework)
# Testing for bias in how policy-neglected "neutral-trusters" are represented in the predictive model.
