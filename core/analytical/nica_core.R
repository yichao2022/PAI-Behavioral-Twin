...
# [PAI-Logic]: Mapping Latent Perspectives
# We treat WaitTime as a random parameter (normal distribution)
# to capture the variance in how people perceive delay (Behavioral Digital Twin).
set.seed(123)
m_mxl <- mlogit(
...
# [PAI-Logic]: Auditing Urban-Rural Psychology Divide (NICA Framework)
# Testing how latent geographic perspectives shift wait-time friction.
m_urban <- mlogit(
